    ...
    public class Kernel : Sys.Kernel
    {
        ...
        protected override void BeforeRun()
        {
            try
            {
                ...
                Console.WriteLine("  Welcome to Progressor Shoosh 0.1.0 Github version of October 2023  ");
                Console.ResetColor();
                Console.ForegroundColor = ConsoleColor.Gray;
        ...
        private void ExecuteCommand(string command)
        {
            switch (command)
            {
                case "help":
                    ...
                    Console.WriteLine("delete [file name] - Delete file;");
